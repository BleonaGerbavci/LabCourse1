...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-EROJ8O8;Initial Catalog=DB_Bus_System;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Autobusi>(entity =>
            {
                entity.HasOne(d => d.Garazha)
                    ...
                    .HasConstraintName("FK__Autobusi__Garazh__59063A47");

                entity.HasOne(d => d.Kompania)
                    .WithMany(p => p.Autobusi)
                    .HasForeignKey(d => d.KompaniaId)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK__Autobusi__Kompan__571DF1D5");

                entity.HasOne(d => d.Stacioni)
                    .WithMany(p => p.Autobusi)
                    .HasForeignKey(d => d.StacioniId)
                    .HasConstraintName("FK__Autobusi__Stacio__5812160E");
            });
            ...
            modelBuilder.Entity<Garazha>(entity =>
            {
                ...
                entity.HasOne(d => d.Kompania)
                    ...
                    .HasForeignKey(d => d.KompaniaId)
                    .HasConstraintName("FK__Garazha__Kompani__3C69FB99");

                entity.HasOne(d => d.ZipCodeNavigation)
                    .WithMany(p => p.Garazha)
                    .HasForeignKey(d => d.ZipCode)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK__Garazha__ZipCode__3B75D760");
            });
            ...
            modelBuilder.Entity<Kompania>(entity =>
            {
                ...
                entity.HasOne(d => d.Pompa)
                    ...
                    .HasConstraintName("FK__Kompania__PompaI__34C8D9D1");

                entity.HasOne(d => d.ZipCodeNavigation)
                    .WithMany(p => p.Kompania)
                    .HasForeignKey(d => d.ZipCode)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK__Kompania__ZipCod__33D4B598");
            });
            ...
            modelBuilder.Entity<Linja>(entity =>
            {
                ...
                entity.HasOne(d => d.Autobusi)
                    ...
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK__Linja__AutobusiI__5BE2A6F2");

                entity.HasOne(d => d.Kompania)
                    .WithMany(p => p.Linja)
                    .HasForeignKey(d => d.KompaniaId)
                    .HasConstraintName("FK__Linja__KompaniaI__5CD6CB2B");
            });
            ...
            modelBuilder.Entity<Oferta>(entity =>
            {
                ...
                entity.HasOne(d => d.Kompania)
                    .WithMany(p => p.Oferta)
                    .HasForeignKey(d => d.KompaniaId)
                    .HasConstraintName("FK__Oferta__Kompania__628FA481");

                entity.HasOne(d => d.Linja)
                    .WithMany(p => p.Oferta)
                    .HasForeignKey(d => d.LinjaId)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK__Oferta__Linja_Id__6383C8BA");
            });
            ...
            modelBuilder.Entity<Pushimi>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    ...
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK__Pushimi__UserID__5FB337D6");
            });

            modelBuilder.Entity<Qyteti>(entity =>
            {
                entity.HasKey(e => e.QytetiZipCode)
                    .HasName("PK__Qyteti__5EC27638563C6067");
            ...
            modelBuilder.Entity<RentAutobusin>(entity =>
            {
                entity.HasKey(e => e.RentId)
                    .HasName("PK__RentAuto__783D47F5CB98AAD7");
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK__RentAutob__UserI__6E01572D");
            });
            ...
            modelBuilder.Entity<Rezervimi>(entity =>
            {
                ...
                entity.HasOne(d => d.Linja)
                    ...
                    .HasForeignKey(d => d.LinjaId)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK__Rezervimi__Linja__6B24EA82");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.Rezervimi)
                    .HasForeignKey(d => d.UserId)
                    .HasConstraintName("FK__Rezervimi__UserI__6A30C649");
            });

            modelBuilder.Entity<RezervoAutobusin>(entity =>
            {
                entity.HasKey(e => e.RezervimiId)
                    .HasName("PK__RezervoA__6F6B8C2B134770F5");
                ...
                entity.HasOne(d => d.Autobusi)
                    ...
                    .HasForeignKey(d => d.AutobusiId)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK__RezervoAu__Autob__75A278F5");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.RezervoAutobusin)
                    .HasForeignKey(d => d.UserId)
                    .HasConstraintName("FK__RezervoAu__UserI__74AE54BC");
            });
            ...
            modelBuilder.Entity<Stacioni>(entity =>
            {
                ...
                entity.HasOne(d => d.ZipCodeNavigation)
                    ...
                    .HasForeignKey(d => d.ZipCode)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK__Stacioni__ZipCod__3F466844");
            });

            modelBuilder.Entity<Useri>(entity =>
            {
                entity.HasKey(e => e.UserId)
                    .HasName("PK__Useri__1788CC4C2915E2FF");

                entity.HasIndex(e => e.Emaili, "UQ__Useri__456F8D026C864529")
                    .IsUnique();
